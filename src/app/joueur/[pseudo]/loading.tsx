  ...
  return (
    <main className="relative min-h-screen overflow-hidden pt-28 pb-16">
      <div className="relative mx-auto max-w-3xl px-6">
        <div className="flex flex-wrap items-start justify-between gap-6 rounded-[3px] border border-trait bg-carte p-4">
        ...
        <div className="mt-4 grid grid-cols-3 gap-[1px] overflow-hidden rounded-[3px] border border-trait">
