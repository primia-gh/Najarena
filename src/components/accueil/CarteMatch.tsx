...
export default function CarteMatch() {
  return (
    <div
      className="border border-trait bg-carte p-6 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.6)] transition-[border-color,box-shadow] duration-300 hover:border-sceau/40 hover:shadow-[0_0_0_1px_rgba(196,72,92,0.3),0_24px_60px_-12px_var(--color-sceau-lueur)]"
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="font-mono text-[0.68rem] text-ardoise">#TRN-0842</span>
      </div>

      <div className="mb-4 flex flex-col gap-2">
        <div className="flex items-center justify-between font-semibold text-encre">
          <span>KaisaMain</span>
          <span className="font-mono tabular-nums">2</span>
        </div>
        <div className="flex items-center justify-between text-ardoise">
          <span>Faker_du_dimanche</span>
          <span className="font-mono tabular-nums">0</span>
        </div>
      </div>

      <span className="inline-flex items-center gap-1.5 rounded-full bg-[var(--color-atteste-lueur)] px-2.5 py-1 font-mono text-[0.62rem] tracking-[0.08em] text-atteste uppercase">
