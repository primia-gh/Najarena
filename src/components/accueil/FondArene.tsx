  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(var(--nuit-trait) 1px, transparent 1px), linear-gradient(90deg, var(--nuit-trait) 1px, transparent 1px)",
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, var(--nuit-sceau-lueur) 0%, transparent 65%)" }}
      />
      <div
        className="absolute -right-[10%] -bottom-[20%] h-[700px] w-[700px] blur-[10px]"
        style={{ background: "radial-gradient(circle, var(--nuit-laiton-lueur) 0%, transparent 65%)" }}
      />
    </div>
  );
}
