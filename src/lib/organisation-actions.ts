...
// Ordre standard de placement dans un bracket à élimination simple :
// répartit les "byes" (places vides quand il y a moins de joueurs que de
// places) le plus loin possible les uns des autres, pour qu'aucun match ne
// se retrouve avec deux places vides à la fois — sans cet ordre, un match
// sans aucun participant ne se résoudrait jamais et bloquerait tout le
// tour suivant. Pour capacite=4 : [1,4,2,3] (seed1 vs seed4, seed2 vs seed3).
function ordreDesSeeds(capacite: number): number[] {
