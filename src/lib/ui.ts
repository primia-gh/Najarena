...
export function classeBoutonPrimaire(): string {
  return "inline-block rounded-[3px] bg-sceau px-4 py-2 text-sm font-semibold text-papier shadow-[0_4px_14px_-4px_rgba(126,34,51,0.35)] transition-[transform,box-shadow,filter] duration-200 hover:-translate-y-0.5 hover:brightness-110 hover:shadow-[0_8px_20px_-6px_rgba(126,34,51,0.4)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sceau";
}
